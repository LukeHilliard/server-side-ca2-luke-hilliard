...
<div class="w-4/5 m-auto pt-5">
    ...
    <div class="flex flex-col items-center justify-center pt-10">
        <div class="w-full max-w-md bg-white rounded-lg shadow-md p-6">
            <h2 class="text-2xl font-bold text-gray-900 mb-4 text-center">Enquiry Form</h2>
            ...
            <form class="flex flex-col"
                ...
                <textarea name="message" placeholder="Enquiry" class="bg-gray-100 text-gray-900 border-0 rounded-md p-2 mb-4 focus:bg-gray-200 focus:outline-none focus:ring-1 focus:ring-blue-500 transition ease-in-out duration-150"></textarea>
